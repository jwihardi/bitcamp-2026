...
export function PromptEditorModal({ agent, isEvaluating, onClose, onAnalyze }: PromptEditorModalProps) {
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-[10px] p-3 text-sm leading-relaxed outline-none focus:ring-2"
              style={{
                minHeight: 120,
                border: '1px solid #d9d9d9',
                background: '#fafafa',
