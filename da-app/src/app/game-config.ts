...
export const INITIAL_MODELS: Model[] = [
  { id: 'nimbus_1',     name: 'Nimbus-1',     costPerToken: 0.010, qualityMultiplier: 1.0, unlockCost: 0,      unlocked: true  },
  { id: 'quanta_s',     name: 'Quanta-S',     costPerToken: 0.060, qualityMultiplier: 1.3, unlockCost: 500,    unlocked: false },
  { id: 'synapse_pro',  name: 'Synapse Pro',  costPerToken: 0.100, qualityMultiplier: 1.5, unlockCost: 5000,   unlocked: false },
  { id: 'oracle_ultra', name: 'Oracle Ultra', costPerToken: 0.180, qualityMultiplier: 1.8, unlockCost: 25000,  unlocked: false },
  { id: 'oracle_apex',  name: 'Oracle Apex',  costPerToken: 0.400, qualityMultiplier: 2.2, unlockCost: 100000, unlocked: false },
]
...
export const FUNDING_STAGES: FundingStage[] = [
  ...
  { id: 'series-a',  name: 'Series A',     userRequirement: 20000,   revenueRequirement: 15000,    profitRequirement: 400,    reputationGain: 8  },
  { id: 'series-b',  name: 'Series B',     userRequirement: 300000,  revenueRequirement: 200000,   profitRequirement: 2500,   reputationGain: 15 },
  { id: 'series-c',  name: 'Series C',     userRequirement: 2000000, revenueRequirement: 1000000,  profitRequirement: 12000,  reputationGain: 25 },
  { id: 'ipo',       name: 'IPO',          userRequirement: 8000000, revenueRequirement: 4000000,  profitRequirement: 50000,  reputationGain: 60 },
]
